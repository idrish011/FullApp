...
const CollegeAdminLayout = ({ children, title, subtitle }) => {
  ...
  const getBreadcrumbs = () => {
    ...
    switch (pathname) {
      case '/students':
        breadcrumbs.push({ label: 'Students', path: '/students' });
        break;
      case '/teachers':
        breadcrumbs.push({ label: 'Teachers', path: '/teachers' });
        break;
      case '/courses':
      ...
      case '/admission-inquiry':
        breadcrumbs.push({ label: 'Admission Inquiry', path: '/admission-inquiry' });
        break;
      default:
        break;
    }
