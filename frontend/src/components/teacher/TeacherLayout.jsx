...
const TeacherLayout = ({ children, title, subtitle }) => {
  ...
  const getBreadcrumbs = () => {
    ...
    switch (pathname) {
      case '/assignments':
        breadcrumbs.push({ label: 'Assignments', path: '/assignments', icon: <AssignmentIcon /> });
        break;
      case '/attendance':
        breadcrumbs.push({ label: 'Attendance', path: '/attendance', icon: <ScheduleIcon /> });
        break;
      case '/grades':
        breadcrumbs.push({ label: 'Grades', path: '/grades', icon: <GradeIcon /> });
        break;
      default:
        break;
    }
